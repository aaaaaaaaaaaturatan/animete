...
lib.ssMetadata = [
		{name:"testrocket_atlas_1", frames: [[1498,0,164,94],[1282,341,384,82],[1282,0,214,339],[1664,0,1,54],[0,0,1280,720]]}
];
...
(lib.CachedBmp_4 = function() {
	this.initialize(ss["testrocket_atlas_1"]);
	this.gotoAndStop(0);
...
(lib.発射ボタン = function(mode,startPosition,loop,reversed) {
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(53,0,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(0.5,0,192,47);
...
// stage content:
(lib.testrocket = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		var _this = this;
		this.launch_btn.on('click', function(evt){
	...
	// 発射ボタン
	this.launch_btn = new lib.発射ボタン();
	this.launch_btn.name = "launch_btn";
	this.launch_btn.setTransform(271.5,370.6,1,1,0,0,0,96.5,23.6);
	new cjs.ButtonHelper(this.launch_btn, 0, 1, 1);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/testrocket_atlas_1.png", id:"testrocket_atlas_1"}
	],
	preloads: []
};
