...
lib.ssMetadata = [
		{name:"名称未設定 _ 1_atlas_1", frames: [[1498,0,164,94],[1282,341,384,82],[1282,0,214,339],[1664,0,1,54],[0,0,1280,720]]}
];
...
(lib.CachedBmp_4 = function() {
	this.initialize(ss["名称未設定 _ 1_atlas_1"]);
	this.gotoAndStop(0);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/名称未設定 _ 1_atlas_1.png", id:"名称未設定 _ 1_atlas_1"}
	],
	preloads: []
};
